  ...
  return (
    ...
    <section className="wrap" style={{top:"130%"}}>
        <div className="wrap-title-section" id="pizzas">
            ...
            {pizzas.map(pizza=>(
                   <Product  linkimagen={pizza.imagenlink} Nombre={pizza.nombre} Tamaño={pizza.tamaño} Precio={pizza.precio} />
            ))}
            </div>
        ...
        <div className="wrap-title-section">
            ...
            {Bebidas.map(bebida=>(
              <Product linkimagen={bebida.imagenlink} Nombre={bebida.nombre} Tamaño={bebida.tamaño} Precio={bebida.precio} />
        ...
        <div className="wrap-title-section">
            ...
            {extras.map(extra=>(
            <Product linkimagen={extra.imagenlink} Nombre={extra.nombre} Tamaño={extra.porcion} Precio={extra.precio} />
            ))}
        </div>
